export const hotels = [
    ...
    { name: "Strand Hotel Singapore", price: 6500, cancelable: true, size: 34, hasSofaBed: false, hasFewOutlets: false, hasNoParking: false, note: "免費無限網路/免費停車場/入住前2天並在14點前方可免費取消" }
];
